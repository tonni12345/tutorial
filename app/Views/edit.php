            ...
            <form method="post" action="<?= base_url("admin") . "/edit" . "/" . $buku->id_buku ?>">
                ...
                <div class="form-group">
                    ...
                    <select id="kategori" class="form-select" name="kategori">
                        ...
                        <option value="Keilmuan" <?php echo $buku->kategori == "Keilmuan" ?
                                                        "selected" : "" ?>>Keilmuan</option>
                        <option value="Bisnis" <?php echo $buku->kategori == "Bisnis" ?
                                                    "selected" : "" ?>>Bisnis</option>
                        <option value="Novel" <?php echo $buku->kategori == "Novel" ?
                                                    "selected" : "" ?>>Novel</option>
                    </select>
                </div>
                <div>
                    ...
                    <select id="id_penerbit" class="form-select" name="id_penerbit">
                        ...
                        <?php foreach ($penerbit as $p) : ?>
                            <option value="<?= $p->id_penerbit ?>" <?php echo $buku->id_penerbit
                                                                        == $p->id_penerbit ? "selected" : "" ?>><?= $p->nama ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="form-group">
