...
<body>
    ...
    <div class="container">
            ...
            <tbody>
                ...
                <?php foreach ($buku as $b) : ?>
                    <tr>
                        ...
                        <td><?= $b->nama; ?></td>
                        <td>
                            <a href="<?= base_url() ?>/admin/edit/<?= $b->id_buku; ?>"
                                class="btn btn-warning">Edit</a>
                            <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                data-bs-target="#deleteModal" data-bs-id="<?= $b->id_buku ?>">
                                Delete
                            </button>
                    </tr>
                <?php endforeach; ?>
        ...
        <a href="<?= base_url() ?>/admin/create/penerbit" class="btn btn-primary">Tambah
            Data</a>
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                <?php foreach ($penerbit as $p) : ?>
                    <tr>
                        ...
                        <td><?= $p->telepon; ?></td>
                        <td>
                            <a href="<?= base_url() ?>/admin/edit/<?= $p->id_penerbit; ?>"
                                class="btn btn-warning">Edit</a>
                            <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                data-bs-target="#deleteModal" data-bs-id="<?= $p->id_penerbit ?>">
                                Delete
                            </button>
                    </tr>
                <?php endforeach; ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-bsdismiss="modal">Tidak</button>
